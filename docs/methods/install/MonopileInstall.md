...
| Jack-up         | `depth, extension``speed_above_depth``speed_below_depth` | calculated |
...
| Upend Monopile   | `monopile.length``crane_rate``wave_height` | calculated |
| Lower Monopile   | `site_depth``crane_rate`                   | calculated |
| Reequip Crane    | `crane_reequip_time`                       | 1h         |
| Drive Monopile   | `mono_drive_rate``mono_embed_len`          | calculated |
...
| ------------- | ---------------------------------- | ---------- |
| Reequip Crane | `crane_reequip_time`               | 1h         |
| Lower TP      | `air_gap``crane_rate``wave_height` | calculated |
...
| Jack-down | `depth, extension``speed_above_depth``speed_below_depth` | calculated |
