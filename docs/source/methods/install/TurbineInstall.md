...
| Lift Tower      | `turbine.hub_height``wtiv.crane_rate``wave_height` | calculated |
| Attach Tower    | `tower_attach_time`                                | 6h         |
| Release Nacelle | `nacelle_release_time`                             | 3h         |
| Lift Nacelle    | `turbine.hub_height``wtiv.crane_rate``wave_height` | calculated |
| Attach Nacelle  | `nacelle_attach_time`                              | 6h         |
| Release Blade   | `blade_release_time`                               | 1h         |
| Lift Blade      | `turbine.hub_height``wtiv.crane_rate``wave_height` | calculated |
