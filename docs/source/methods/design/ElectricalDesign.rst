...
:doc:`Electrical System Design API <../../api/phases/design/ElectricalDesign>`.
...
<CableHelpers>`, specifically :class:`Cable` and :class:`CableSystem`.
...
:doc:`export cable installation module <../install/ExportCableInstall>` and
:doc:`offshore substation installation module <../install/OffshoreSubstationInstall>`
