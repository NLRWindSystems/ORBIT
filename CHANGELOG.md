...
- Updated default `soft_capex` factors. [PR #201](https://github.com/NLRWindSystems/ORBIT/pull/201)
...
- Updated default `project_capex` values. [PR #201](https://github.com/NLRWindSystems/ORBIT/pull/201)
...
- Included onshore substation costs in BOS CapEx and project breakdown. [PR #201](https://github.com/NLRWindSystems/ORBIT/pull/201)
...
- Cable configuration file updates. [PR #201](https://github.com/NLRWindSystems/ORBIT/pull/201)
...
- Updated various default costs to 2024 USD. [PR #187](https://github.com/NLRWindSystems/ORBIT/pull/187)
  ...
  - Added `defaults/costs_by_procurement_year.csv` which provides the default costs for other procurement year,
      but in 2024 USD.
- Bug Fix: Characteristic Impedance calculation correction. [Issue #186](https://github.com/NLRWindSystems/ORBIT/issues/186)
...
- Updated NLRWindSystems API (`wisdem_api.py`)
  ...
  - Updated some tests.
- Enhanced `ProjectManager`: [PR #177](https://github.com/NLRWindSystems/ORBIT/pull/177)
